...
sed -i "s/\\/api\\/v1/${escaped_base_url}\\/api\\/v1/g" /home/django/static/engine/js/*.js || true
sed -i "s/Worker[(]\"\\/static\\//Worker\\(\"${escaped_base_url}\\/static\\//g" /home/django/static/engine/js/*.js || true

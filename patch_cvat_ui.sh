...
sed -i "s/$BASE_URL_KEYWD/${escaped_base_url}/g" /usr/share/nginx/html/assets/*.js /usr/share/nginx/html/assets/*.map
sed -i "s/$BASE_URL_KEYWD/${escaped_base_url}/g" /usr/share/nginx/html/assets/3rdparty/*.js /usr/share/nginx/html/assets/3rdparty/*.map
